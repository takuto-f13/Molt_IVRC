...
Shader "Distant Lands/Cozy/HDRP/Particles/Stylized Butterfly"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				#endif
				float3 vertexValue = ( float3(0,1,0) * sin( ( inputMesh.ase_texcoord1.x * _SwaySpeed ) ) * _SwayAmount * inputMesh.ase_color.r );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
					...
					)
			{
				...
				float4 tex2DNode8_g1 = tex2D( _Texture, uv_Texture );
				
				surfaceDescription.Color = ( _MainColor * tex2DNode8_g1 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( _MainColor.a * tex2DNode8_g1.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 defaultVertexValue = float3( 0, 0, 0 );
				#endif
				float3 vertexValue = ( float3(0,1,0) * sin( ( inputMesh.uv1.x * _SwaySpeed ) ) * _SwayAmount * inputMesh.ase_color.r );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
				inputMesh.positionOS.xyz = vertexValue;
				#else
				inputMesh.positionOS.xyz += vertexValue;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;35;-272,0;Inherit;False;Stylized Butterfly;0;;1;791d8affaa5f2cc4aa6d0710e00a53ed;0;0;4;COLOR;0;FLOAT;13;FLOAT;17;FLOAT3;15
