...
Shader "Distant Lands/Cozy/HDRP/Demo/Stylized Surface Shader"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float snoise( float2 v )
			{
				...
				return 130.0 * dot( m, g );
					...
					float2 voronoihash1_g9( float2 p )
					{
					...
					float voronoi1_g9( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
					...
					float2 voronoihash8_g9( float2 p )
					{
					...
					float voronoi8_g9( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
						...
						)
			{
				...
				float4 lerpResult19_g8 = lerp( ( CZY_SnowColor * tex2D( CZY_SnowTexture, uvCZY_SnowTexture ) ) , ( _MainColor * tex2D( _Albedo, uv_Albedo ) ) , ( ( pow( ( pow( normalWS.y , 7.0 ) * ( simplePerlin2D7_g8 * ( 1.0 - voroi5_g8 ) ) ) , 0.5 ) * _SnowAttraction ) > ( 1.0 - CZY_SnowAmount ) ? 0.0 : 1.0 ));
				...
				float temp_output_5_0_g9 = ( 1.0 / CZY_PuddleScale );
				float time1_g9 = 0.0;
				float2 voronoiSmoothId1_g9 = 0;
				float2 appendResult3_g9 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 coords1_g9 = appendResult3_g9 * temp_output_5_0_g9;
				float2 id1_g9 = 0;
				float2 uv1_g9 = 0;
				float voroi1_g9 = voronoi1_g9( coords1_g9, time1_g9, id1_g9, uv1_g9, 0, voronoiSmoothId1_g9 );
				float time8_g9 = 2.16;
				float2 voronoiSmoothId8_g9 = 0;
				float2 coords8_g9 = packedInput.ase_texcoord5.xy * ( temp_output_5_0_g9 * 3.0 );
				float2 id8_g9 = 0;
				float2 uv8_g9 = 0;
				float voroi8_g9 = voronoi8_g9( coords8_g9, time8_g9, id8_g9, uv8_g9, 0, voronoiSmoothId8_g9 );
				float2 uv_Smoothness = packedInput.ase_texcoord5.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
				float Smoothness18 = ( ( normalWS.y * 2.0 * ( (1.0 + (voroi1_g9 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g9 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0)) ) * (0.3 + (CZY_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0)) ) > ( 1.0 - ( CZY_WetnessAmount * ( _SmoothnessMultiplier * tex2D( _Smoothness, uv_Smoothness ) ).r ) ) ? 1.0 : 0.0 );
				
				surfaceDescription.BaseColor = Albedo11.rgb;
				surfaceDescription.Normal = Normal16.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Metallic24.r;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Emission12.rgb;
				surfaceDescription.Smoothness = Smoothness18;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float time8_g9 = 2.16;
				float2 voronoiSmoothId8_g9 = 0;
				float2 coords8_g9 = packedInput.ase_texcoord2.xy * ( temp_output_5_0_g9 * 3.0 );
				float2 id8_g9 = 0;
				float2 uv8_g9 = 0;
				float voroi8_g9 = voronoi8_g9( coords8_g9, time8_g9, id8_g9, uv8_g9, 0, voronoiSmoothId8_g9 );
				float2 uv_Smoothness = packedInput.ase_texcoord2.xy * _Smoothness_ST.xy + _Smoothness_ST.zw;
				float Smoothness18 = ( ( ase_worldNormal.y * 2.0 * ( (1.0 + (voroi1_g9 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g9 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0)) ) * (0.3 + (CZY_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0)) ) > ( 1.0 - ( CZY_WetnessAmount * ( _SmoothnessMultiplier * tex2D( _Smoothness, uv_Smoothness ) ).r ) ) ? 1.0 : 0.0 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float time8_g9 = 2.16;
				float2 voronoiSmoothId8_g9 = 0;
				float2 coords8_g9 = packedInput.ase_texcoord3.xy * ( temp_output_5_0_g9 * 3.0 );
				float2 id8_g9 = 0;
				float2 uv8_g9 = 0;
				float voroi8_g9 = voronoi8_g9( coords8_g9, time8_g9, id8_g9, uv8_g9, 0, voronoiSmoothId8_g9 );
		...
		Pass
		{
						...
						)
			{
				...
				float time8_g9 = 2.16;
				float2 voronoiSmoothId8_g9 = 0;
				float2 coords8_g9 = packedInput.ase_texcoord7.xy * ( temp_output_5_0_g9 * 3.0 );
				float2 id8_g9 = 0;
				float2 uv8_g9 = 0;
				float voroi8_g9 = voronoi8_g9( coords8_g9, time8_g9, id8_g9, uv8_g9, 0, voronoiSmoothId8_g9 );
...
Node;AmplifyShaderEditor.FunctionNode;25;-213.0329,-297.0902;Inherit;False;Stylized Snow Blend;10;;8;359b695eb7172584f9df5a0d55bd52e9;0;3;37;SAMPLERSTATE;0;False;34;FLOAT;0;False;22;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;28;-118.007,198.6135;Inherit;False;StylizedRainPuddles;-1;;9;ff913d501aadc8b4cb4ec6889f2354ca;0;1;14;FLOAT;1;False;1;FLOAT;0
...
WireConnection;29;6;14;0
WireConnection;29;7;19;0
ASEEND*/
//CHKSM=01B559B26D40925F6440221AD7E024CC22B6C341