...
Shader "Distant Lands/Cozy/HDRP/Stylized Sky (Mobile)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 hsvTorgb2_g68 = RGBToHSV( CZY_HorizonColor.rgb );
				...
				float4 HorizonColor76_g67 = temp_output_10_0_g68;
				float3 hsvTorgb2_g69 = RGBToHSV( CZY_ZenithColor.rgb );
				...
				float4 ZenithColor78_g67 = temp_output_10_0_g69;
				float2 texCoord13_g67 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_17_0_g67 = ( texCoord13_g67 - float2( 0.5,0.5 ) );
				float dotResult9_g67 = dot( temp_output_17_0_g67 , temp_output_17_0_g67 );
				float SimpleGradient33_g67 = dotResult9_g67;
				float GradientPos44_g67 = ( 1.0 - saturate( pow( saturate( (0.0 + (SimpleGradient33_g67 - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , CZY_Power ) ) );
				float4 lerpResult65_g67 = lerp( HorizonColor76_g67 , ZenithColor78_g67 , saturate( GradientPos44_g67 ));
				float4 SimpleSkyGradient114_g67 = lerpResult65_g67;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult28_g67 = normalize( ( ase_worldPos - _WorldSpaceCameraPos ) );
				float dotResult39_g67 = dot( normalizeResult28_g67 , CZY_SunDirection );
				float SunDot69_g67 = dotResult39_g67;
				float3 hsvTorgb2_g71 = RGBToHSV( CZY_SunFlareColor.rgb );
				...
				half4 SunFlare121_g67 = abs( ( saturate( pow( abs( (SunDot69_g67*0.5 + 0.5) ) , CZY_SunFlareFalloff ) ) * temp_output_10_0_g71 ) );
				float4 SunRender41_g67 = ( CZY_SunColor * ( ( 1.0 - SunDot69_g67 ) > ( pow( CZY_SunSize , 3.0 ) * 0.0007 ) ? 0.0 : 1.0 ) );
				float2 texCoord20_g67 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Pos8_g67 = texCoord20_g67;
				float mulTime85_g67 = _TimeParameters.x * 0.005;
				float cos82_g67 = cos( mulTime85_g67 );
				float sin82_g67 = sin( mulTime85_g67 );
				float2 rotator82_g67 = mul( Pos8_g67 - float2( 0.5,0.5 ) , float2x2( cos82_g67 , -sin82_g67 , sin82_g67 , cos82_g67 )) + float2( 0.5,0.5 );
				float mulTime81_g67 = _TimeParameters.x * -0.02;
				float simplePerlin2D97_g67 = snoise( (Pos8_g67*5.0 + mulTime81_g67) );
				simplePerlin2D97_g67 = simplePerlin2D97_g67*0.5 + 0.5;
				float StarPlacementPattern108_g67 = saturate( ( min( tex2D( CZY_GalaxyVariationMap, (Pos8_g67*5.0 + mulTime85_g67) ).r , tex2D( CZY_GalaxyVariationMap, (rotator82_g67*2.0 + 0.0) ).r ) * simplePerlin2D97_g67 * (0.2 + (SimpleGradient33_g67 - 0.0) * (0.0 - 0.2) / (1.0 - 0.0)) ) );
				float2 panner104_g67 = ( 1.0 * _Time.y * float2( 0.0007,0 ) + Pos8_g67);
				float mulTime94_g67 = _TimeParameters.x * 0.001;
				float cos92_g67 = cos( 0.01 * _Time.y );
				float sin92_g67 = sin( 0.01 * _Time.y );
				float2 rotator92_g67 = mul( Pos8_g67 - float2( 0.5,0.5 ) , float2x2( cos92_g67 , -sin92_g67 , sin92_g67 , cos92_g67 )) + float2( 0.5,0.5 );
				float4 StarPattern101_g67 = saturate( ( ( ( StarPlacementPattern108_g67 * min( tex2D( CZY_StarMap, (panner104_g67*4.0 + mulTime94_g67) ).r , tex2D( CZY_StarMap, (rotator92_g67*0.1 + 0.0) ).r ) ) * ( 1.0 - HorizonColor76_g67.r ) ) * CZY_StarColor ) );
				
				surfaceDescription.Color = ( SimpleSkyGradient114_g67 + SunFlare121_g67 + SunRender41_g67 + HorizonColor76_g67 + StarPattern101_g67 ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 temp_output_10_0_g69 = ( float4( hsvTorgb3_g69 , 0.0 ) * CZY_FilterColor );
				float4 ZenithColor78_g67 = temp_output_10_0_g69;
				float2 texCoord13_g67 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_17_0_g67 = ( texCoord13_g67 - float2( 0.5,0.5 ) );
				float dotResult9_g67 = dot( temp_output_17_0_g67 , temp_output_17_0_g67 );
				float SimpleGradient33_g67 = dotResult9_g67;
				float GradientPos44_g67 = ( 1.0 - saturate( pow( saturate( (0.0 + (SimpleGradient33_g67 - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , CZY_Power ) ) );
				...
				half4 SunFlare121_g67 = abs( ( saturate( pow( abs( (SunDot69_g67*0.5 + 0.5) ) , CZY_SunFlareFalloff ) ) * temp_output_10_0_g71 ) );
				float4 SunRender41_g67 = ( CZY_SunColor * ( ( 1.0 - SunDot69_g67 ) > ( pow( CZY_SunSize , 3.0 ) * 0.0007 ) ? 0.0 : 1.0 ) );
				float2 texCoord20_g67 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Pos8_g67 = texCoord20_g67;
				float mulTime85_g67 = _TimeParameters.x * 0.005;
				float cos82_g67 = cos( mulTime85_g67 );
				float sin82_g67 = sin( mulTime85_g67 );
