...
Shader "Distant Lands/Cozy/HDRP/Stylized Sky (Desktop)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord135_g5 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_136_0_g5 = ( texCoord135_g5 - float2( 0.5,0.5 ) );
				...
				float2 texCoord8_g5 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Pos17_g5 = texCoord8_g5;
				float mulTime41_g5 = _TimeParameters.x * 0.005;
				...
				float mulTime36_g5 = _TimeParameters.x * -0.02;
				...
				float mulTime75_g5 = _TimeParameters.x * 0.001;
				...
				float mulTime13_g5 = _TimeParameters.x * 0.005;
				float2 panner14_g5 = ( 1.0 * _Time.y * float2( 0.001,0 ) + Pos17_g5);
				float mulTime11_g5 = _TimeParameters.x * 0.005;
				...
				float4 localWorldVar185_g5 = float4( ase_worldPos , 0.0 );
				(localWorldVar185_g5).xyz = GetCameraRelativePositionWS((localWorldVar185_g5).xyz);
				float4 transform185_g5 = mul(GetWorldToObjectMatrix(),localWorldVar185_g5);
				...
				surfaceDescription.Color = ( SimpleSkyGradient127_g5 + SunFlare143_g5 + SunRender219_g5 + MoonFlare53_g5 + GalaxyFullColor120_g5 + RainbowClipping112_g5 + LightColumnsColor114_g5 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( 1.0 - 0.0 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 temp_output_10_0_g7 = ( float4( hsvTorgb3_g7 , 0.0 ) * CZY_FilterColor );
				float4 ZenithColor139_g5 = temp_output_10_0_g7;
				float2 texCoord135_g5 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_136_0_g5 = ( texCoord135_g5 - float2( 0.5,0.5 ) );
				float dotResult138_g5 = dot( temp_output_136_0_g5 , temp_output_136_0_g5 );
				float SimpleGradient137_g5 = dotResult138_g5;
				float GradientPos132_g5 = ( 1.0 - saturate( pow( saturate( (0.0 + (SimpleGradient137_g5 - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , CZY_Power ) ) );
				...
				float4 temp_output_10_0_g8 = ( float4( hsvTorgb3_g8 , 0.0 ) * CZY_FilterColor );
				half4 MoonFlare53_g5 = abs( ( saturate( pow( saturate( (MoonDot240_g5*0.5 + 0.4) ) , ( ( CZY_MoonFlareFalloff * 20.0 ) + 5.0 ) ) ) * temp_output_10_0_g8 ) );
				float2 texCoord8_g5 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Pos17_g5 = texCoord8_g5;
				float mulTime41_g5 = _TimeParameters.x * 0.005;
				float cos18_g5 = cos( mulTime41_g5 );
				float sin18_g5 = sin( mulTime41_g5 );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;426;-912,336;Inherit;False;Stylized Sky (Desktop);0;;5;6fc9715951ffc7d4dae1a16a0961dc28;0;0;2;COLOR;0;FLOAT;245
