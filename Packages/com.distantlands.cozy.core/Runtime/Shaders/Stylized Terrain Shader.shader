...
Shader "Distant Lands/Cozy/BiRP/Demo/Stylized Terrain First Pass"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode5_g84 = tex2D( _Control, uv_Control );
			float dotResult20_g84 = dot( tex2DNode5_g84 , float4(1,1,1,1) );
			float SplatWeight22_g84 = dotResult20_g84;
			float localSplatClip74_g84 = ( SplatWeight22_g84 );
			float SplatWeight74_g84 = SplatWeight22_g84;
			{
			#if !defined(SHADER_API_MOBILE) && defined(TERRAIN_SPLAT_ADDPASS)
				clip(SplatWeight74_g84 == 0.0f ? -1 : 1);
			#endif
			}
			float4 SplatControl26_g84 = ( tex2DNode5_g84 / ( localSplatClip74_g84 + 0.001 ) );
			float4 temp_output_59_0_g84 = SplatControl26_g84;
			float4 break20_g86 = temp_output_59_0_g84;
			float4 lerpResult16_g86 = lerp( float4( 0,0,0,0 ) , tex2D( _Normal0, uv_Splat0 ) , ( break20_g86.r > max( max( break20_g86.g , break20_g86.b ) , break20_g86.a ) ? 1.0 : 0.0 ));
			float2 uv_Splat1 = i.uv_texcoord * _Splat1_ST.xy + _Splat1_ST.zw;
			float4 lerpResult14_g86 = lerp( lerpResult16_g86 , tex2D( _Normal1, uv_Splat1 ) , ( break20_g86.g > max( max( break20_g86.r , break20_g86.b ) , break20_g86.a ) ? 1.0 : 0.0 ));
			float2 uv_Splat2 = i.uv_texcoord * _Splat2_ST.xy + _Splat2_ST.zw;
			float4 lerpResult8_g86 = lerp( lerpResult14_g86 , tex2D( _Normal2, uv_Splat2 ) , ( break20_g86.b > max( max( break20_g86.r , break20_g86.g ) , break20_g86.a ) ? 1.0 : 0.0 ));
			float2 uv_Splat3 = i.uv_texcoord * _Splat3_ST.xy + _Splat3_ST.zw;
			float4 lerpResult13_g86 = lerp( lerpResult8_g86 , tex2D( _Normal3, uv_Splat3 ) , ( break20_g86.a > max( max( break20_g86.r , break20_g86.g ) , break20_g86.b ) ? 1.0 : 0.0 ));
			float3 temp_output_61_0_g84 = UnpackNormal( saturate( lerpResult13_g86 ) );
			o.Normal = temp_output_61_0_g84;
			float2 uvCZY_SnowTexture = i.uv_texcoord * CZY_SnowTexture_ST.xy + CZY_SnowTexture_ST.zw;
			float4 appendResult33_g84 = (float4(1.0 , 1.0 , 1.0 , _Smoothness0));
			float4 tex2DNode4_g84 = tex2D( _Splat0, uv_Splat0 );
			float4 break20_g85 = temp_output_59_0_g84;
			float4 lerpResult16_g85 = lerp( float4( 0,0,0,0 ) , ( appendResult33_g84 * tex2DNode4_g84 * _Specular0 ) , ( break20_g85.r > max( max( break20_g85.g , break20_g85.b ) , break20_g85.a ) ? 1.0 : 0.0 ));
			float4 appendResult36_g84 = (float4(1.0 , 1.0 , 1.0 , _Smoothness1));
			float4 tex2DNode3_g84 = tex2D( _Splat1, uv_Splat1 );
			float4 lerpResult14_g85 = lerp( lerpResult16_g85 , ( appendResult36_g84 * tex2DNode3_g84 * _Specular1 ) , ( break20_g85.g > max( max( break20_g85.r , break20_g85.b ) , break20_g85.a ) ? 1.0 : 0.0 ));
			float4 appendResult39_g84 = (float4(1.0 , 1.0 , 1.0 , _Smoothness2));
			float4 tex2DNode6_g84 = tex2D( _Splat2, uv_Splat2 );
			float4 lerpResult8_g85 = lerp( lerpResult14_g85 , ( appendResult39_g84 * tex2DNode6_g84 * _Specular2 ) , ( break20_g85.b > max( max( break20_g85.r , break20_g85.g ) , break20_g85.a ) ? 1.0 : 0.0 ));
			float4 appendResult42_g84 = (float4(1.0 , 1.0 , 1.0 , _Smoothness3));
			float4 tex2DNode7_g84 = tex2D( _Splat3, uv_Splat3 );
			float4 lerpResult13_g85 = lerp( lerpResult8_g85 , ( appendResult42_g84 * tex2DNode7_g84 * _Specular3 ) , ( break20_g85.a > max( max( break20_g85.r , break20_g85.g ) , break20_g85.b ) ? 1.0 : 0.0 ));
			float4 MixDiffuse28_g84 = saturate( lerpResult13_g85 );
			float4 temp_output_60_0_g84 = MixDiffuse28_g84;
			float4 localClipHoles100_g84 = ( temp_output_60_0_g84 );
			float2 uv_TerrainHolesTexture = i.uv_texcoord * _TerrainHolesTexture_ST.xy + _TerrainHolesTexture_ST.zw;
			float holeClipValue99_g84 = tex2D( _TerrainHolesTexture, uv_TerrainHolesTexture ).r;
			float Hole100_g84 = holeClipValue99_g84;
			{
			#ifdef _ALPHATEST_ON
				clip(Hole100_g84 == 0.0f ? -1 : 1);
			#endif
			}
			...
			float4 appendResult55_g84 = (float4(_Metallic0 , _Metallic1 , _Metallic2 , _Metallic3));
			float dotResult53_g84 = dot( SplatControl26_g84 , appendResult55_g84 );
			float4 lerpResult19_g81 = lerp( ( CZY_SnowColor * tex2D( CZY_SnowTexture, uvCZY_SnowTexture ) ) , localClipHoles100_g84 , ( ( pow( ( pow( ase_worldNormal.y , 7.0 ) * ( simplePerlin2D7_g81 * ( 1.0 - voroi5_g81 ) ) ) , 0.5 ) * dotResult53_g84 ) > ( 1.0 - CZY_SnowAmount ) ? 0.0 : 1.0 ));
			...
			float4 appendResult205_g84 = (float4(_Smoothness0 , _Smoothness1 , _Smoothness2 , _Smoothness3));
			float4 appendResult206_g84 = (float4(tex2DNode4_g84.a , tex2DNode3_g84.a , tex2DNode6_g84.a , tex2DNode7_g84.a));
			float4 defaultSmoothness210_g84 = ( appendResult205_g84 * appendResult206_g84 );
			float dotResult216_g84 = dot( defaultSmoothness210_g84 , SplatControl26_g84 );
			o.Smoothness = ( ( ase_worldNormal.y * 2.0 * ( (1.0 + (voroi1_g83 - 0.0) * (0.0 - 1.0) / (0.4 - 0.0)) + (0.1 + (voroi8_g83 - 0.0) * (-0.3 - 0.1) / (0.21 - 0.0)) ) * (0.3 + (CZY_WetnessAmount - 0.0) * (1.0 - 0.3) / (1.0 - 0.0)) ) > ( 1.0 - ( CZY_WetnessAmount * dotResult216_g84 ) ) ? 1.0 : 0.0 );
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.ColorNode;65;-86.21644,-201.3231;Inherit;False;Property;_RockColor;Rock Color;35;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3773585,0.3773585,0.3773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;137;-89.8521,162.4091;Inherit;False;Stylized Snow Blend;32;;81;359b695eb7172584f9df5a0d55bd52e9;0;2;34;FLOAT;1;False;22;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;848.0565,47.11808;Float;False;True;-1;2;;0;0;Standard;Distant Lands/Cozy/BiRP/Demo/Stylized Terrain First Pass;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;True;-100;True;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;Nature/Terrain/Diffuse;36;-1;-1;-1;0;False;2;BaseMapShader=Distant Lands/Stylized Terrain;AddPassShader=Distant Lands/Stylized Terrain Add Pass;0;False;;-1;0;False;;0;1;finalcolor:SplatmapFinalColor;0;True;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
