...
Shader "Distant Lands/Cozy/HDRP/Stylized Moon"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Normals = packedInput.ase_texcoord1.xy * _Normals_ST.xy + _Normals_ST.zw;
				...
				surfaceDescription.Color = CZY_MoonColor.rgb;
...
Node;AmplifyShaderEditor.Vector3Node;14;-1024,288;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;1;0;Create;True;0;0;0;False;0;False;0,1,0;-0.3908831,0.8096821,0.4377502;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;11;-528,-224;Inherit;False;Global;CZY_MoonColor;CZY_MoonColor;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;2,2,2,0.2536049;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=62726AC417DBE8101DB05030005A0CF447212CBB