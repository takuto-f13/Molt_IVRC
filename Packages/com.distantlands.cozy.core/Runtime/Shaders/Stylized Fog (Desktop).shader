...
Shader "Distant Lands/Cozy/HDRP/Stylized Fog (Desktop)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 InvertDepthDirHD73_g53( float3 In )
			{
				float3 result = In;
					...
					)
			{
				...
				float clampDepth69_g53 = SampleCameraDepth( ase_screenPosNorm.xy );
				...
				float3 In73_g53 = temp_output_46_0_g53;
				float3 localInvertDepthDirHD73_g53 = InvertDepthDirHD73_g53( In73_g53 );
				float4 appendResult49_g53 = (float4(localInvertDepthDirHD73_g53 , 1.0));
				float4 temp_output_97_0_g52 = mul( unity_CameraToWorld, appendResult49_g53 );
				float preDepth120_g52 = distance( temp_output_97_0_g52 , float4( _WorldSpaceCameraPos , 0.0 ) );
				float lerpResult114_g52 = lerp( preDepth120_g52 , ( preDepth120_g52 * (( 1.0 - CZY_VariationAmount ) + (tex2D( _FogVariationTexture, (( (temp_output_97_0_g52).xz + ( (CZY_VariationWindDirection).xz * _TimeParameters.x ) )*( 0.1 / CZY_VariationScale ) + 0.0) ).r - 0.0) * (1.0 - ( 1.0 - CZY_VariationAmount )) / (1.0 - 0.0)) ) , ( 1.0 - saturate( ( preDepth120_g52 / CZY_VariationDistance ) ) ));
				...
				float temp_output_75_0_g52 = ( finalAlpha141_g52 * saturate( ( ( 1.0 - saturate( ( ( ( direction90_g52.y * 0.1 ) * ( 1.0 / ( ( CZY_FogSmoothness * length( ase_objectScale ) ) * 10.0 ) ) ) + ( 1.0 - CZY_FogOffset ) ) ) ) * CZY_FogIntensity ) ) );
				
				surfaceDescription.Color = ( ( temp_output_10_0_g56 * CZY_SunFilterColor ) + temp_output_10_0_g55 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = temp_output_75_0_g52;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;302;-432,128;Inherit;False;Stylized Fog (Desktop);0;;52;649d2917c22fd754aa7be82b00ec0d80;0;2;151;FLOAT;0;False;91;FLOAT3;0,0,0;False;2;COLOR;0;FLOAT;56
