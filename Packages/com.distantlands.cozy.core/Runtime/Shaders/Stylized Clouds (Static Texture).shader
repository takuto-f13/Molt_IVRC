...
Shader "Distant Lands/Cozy/HDRP/Stylized Clouds (Single Texture)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 break15_g70 = CZY_TexturePanDirection;
				float mulTime18_g70 = _TimeParameters.x * ( CZY_WindSpeed * 0.005 );
				float TIme16_g70 = mulTime18_g70;
				float2 appendResult11_g70 = (float2(( break15_g70.x * 0.0025 * TIme16_g70 ) , ( TIme16_g70 * 0.0025 * break15_g70.z )));
				float2 texCoord10_g70 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + appendResult11_g70;
				float cos17_g70 = cos( ( TIme16_g70 * break15_g70.y ) );
				float sin17_g70 = sin( ( TIme16_g70 * break15_g70.y ) );
				float2 rotator17_g70 = mul( texCoord10_g70 - float2( 0.5,0.5 ) , float2x2( cos17_g70 , -sin17_g70 , sin17_g70 , cos17_g70 )) + float2( 0.5,0.5 );
				float4 tex2DNode25_g70 = tex2D( CZY_CloudTexture, rotator17_g70 );
				float4 CloudTex6_g70 = tex2DNode25_g70;
				
				float CloudAlpha3_g70 = ( tex2DNode25_g70.r * tex2DNode25_g70.g * tex2DNode25_g70.b * tex2DNode25_g70.a );
				
				surfaceDescription.Color = ( CloudTex6_g70 * CloudTex6_g70 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( CloudAlpha3_g70 * ( 1.0 - 0.0 ) );
		...
		Pass
		{
					...
					)
			{
				...
				float TIme16_g70 = mulTime18_g70;
				float2 appendResult11_g70 = (float2(( break15_g70.x * 0.0025 * TIme16_g70 ) , ( TIme16_g70 * 0.0025 * break15_g70.z )));
				float2 texCoord10_g70 = packedInput.ase_texcoord.xy * float2( 1,1 ) + appendResult11_g70;
				float cos17_g70 = cos( ( TIme16_g70 * break15_g70.y ) );
				float sin17_g70 = sin( ( TIme16_g70 * break15_g70.y ) );
				float2 rotator17_g70 = mul( texCoord10_g70 - float2( 0.5,0.5 ) , float2x2( cos17_g70 , -sin17_g70 , sin17_g70 , cos17_g70 )) + float2( 0.5,0.5 );
				float4 tex2DNode25_g70 = tex2D( CZY_CloudTexture, rotator17_g70 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float TIme16_g70 = mulTime18_g70;
				float2 appendResult11_g70 = (float2(( break15_g70.x * 0.0025 * TIme16_g70 ) , ( TIme16_g70 * 0.0025 * break15_g70.z )));
				float2 texCoord10_g70 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + appendResult11_g70;
				float cos17_g70 = cos( ( TIme16_g70 * break15_g70.y ) );
				float sin17_g70 = sin( ( TIme16_g70 * break15_g70.y ) );
				float2 rotator17_g70 = mul( texCoord10_g70 - float2( 0.5,0.5 ) , float2x2( cos17_g70 , -sin17_g70 , sin17_g70 , cos17_g70 )) + float2( 0.5,0.5 );
				float4 tex2DNode25_g70 = tex2D( CZY_CloudTexture, rotator17_g70 );
...
WireConnection;820;2;831;31
WireConnection;820;3;831;32
ASEEND*/
//CHKSM=A1BF732C18C088484957918A850F46545531F2F1