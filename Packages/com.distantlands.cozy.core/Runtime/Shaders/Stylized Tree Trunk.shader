...
Shader "Distant Lands/Cozy/HDRP/Demo/Stylized Tree Trunk"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord69 = inputMesh.ase_texcoord.xy * float2( 0,0 ) + appendResult68;
				float simplePerlin2D74 = snoise( texCoord69*_WindNoiseSize );
				float clampResult85 = clamp( inputMesh.positionOS.y , 0.0 , 1000.0 );
						...
						)
			{
				...
				float4 lerpResult19_g1 = lerp( ( CZY_SnowColor * tex2D( CZY_SnowTexture, uvCZY_SnowTexture ) ) , _MainColor , ( ( pow( ( pow( normalWS.y , 7.0 ) * ( simplePerlin2D7_g1 * ( 1.0 - voroi5_g1 ) ) ) , 0.5 ) * _SnowAttraction ) > ( 1.0 - CZY_SnowAmount ) ? 0.0 : 1.0 ));
				
				surfaceDescription.BaseColor = lerpResult19_g1.rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				transform63.xyz = GetAbsolutePositionWS((transform63).xyz);
				float2 appendResult68 = (float2(( ( transform63.x + transform63.z ) / 10.0 ) , CZY_WindTime));
				float2 texCoord69 = inputMesh.uv0.xy * float2( 0,0 ) + appendResult68;
				float simplePerlin2D74 = snoise( texCoord69*_WindNoiseSize );
				float clampResult85 = clamp( inputMesh.positionOS.y , 0.0 , 1000.0 );
				float3 MainWind83 = ( CZY_WindDirection * ( _WindStrength * simplePerlin2D74 * ( 0.1 * clampResult85 ) ) );
				float3 worldToObjDir61 = mul( GetWorldToObjectMatrix(), float4( MainWind83, 0 ) ).xyz;
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-2937.719,1215.111;Inherit;False;Global;CZY_WindTime;CZY_WindTime;3;0;Create;True;0;0;0;False;0;False;1;661.8198;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;76;-1465.965,811.3168;Inherit;False;Global;CZY_WindDirection;CZY_WindDirection;3;0;Create;True;0;0;0;False;0;False;0,0,0;0.1826822,0,-0.4654323;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;86;-67.50684,36.02577;Inherit;False;Stylized Snow Blend;1;;1;359b695eb7172584f9df5a0d55bd52e9;0;3;37;SAMPLERSTATE;0;False;34;FLOAT;1;False;22;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;99;7;97;0
WireConnection;99;11;61;0
ASEEND*/
//CHKSM=1B09D203D8AB770689B3C650F44D72A4C37C03BB