...
Shader "Distant Lands/Cozy/HDRP/Fog Culling"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 InvertDepthDirHD73_g20( float3 In )
			{
				float3 result = In;
			...
			float3 InvertDepthDirHD73_g2( float3 In )
			{
				float3 result = In;
				#if !defined(ASE_SRP_VERSION) || ASE_SRP_VERSION <= 70301 || ASE_SRP_VERSION == 70503 || ASE_SRP_VERSION == 70600 || ASE_SRP_VERSION == 70700 || ASE_SRP_VERSION == 70701 || ASE_SRP_VERSION >= 80301
				result *= float3(1,1,-1);
					...
					)
			{
				...
				float3 break20_g1 = ( ase_objectScale * float3( 0.5,0.5,0.5 ) );
				float3 objToWorld30_g1 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float isInsideBoundingBox5_g1 = ( ( break20_g1.x > abs( ( _WorldSpaceCameraPos.x - objToWorld30_g1.x ) ) ? 1.0 : 0.0 ) * ( break20_g1.y > abs( ( _WorldSpaceCameraPos.y - objToWorld30_g1.y ) ) ? 1.0 : 0.0 ) * ( break20_g1.z >= abs( ( _WorldSpaceCameraPos.z - objToWorld30_g1.z ) ) ? 1.0 : 0.0 ) );
				float temp_output_19_0_g1 = ( 1.0 - isInsideBoundingBox5_g1 );
				float4 screenPos = packedInput.ase_texcoord1;
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float4 fetchOpaqueVal25_g1 = ASEHDSampleSceneColor(ase_grabScreenPosNorm, 0.0, GetInverseCurrentExposureMultiplier());
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float temp_output_12_0_g1 = length( ( ase_worldPos - _WorldSpaceCameraPos ) );
				float preDepth120_g19 = ( temp_output_12_0_g1 - _Thickness );
				...
				float clampDepth69_g20 = SampleCameraDepth( ase_screenPosNorm.xy );
				...
				float3 In73_g20 = temp_output_46_0_g20;
				float3 localInvertDepthDirHD73_g20 = InvertDepthDirHD73_g20( In73_g20 );
				float4 appendResult49_g20 = (float4(localInvertDepthDirHD73_g20 , 1.0));
				float4 temp_output_97_0_g19 = mul( unity_CameraToWorld, appendResult49_g20 );
				float lerpResult114_g19 = lerp( preDepth120_g19 , ( preDepth120_g19 * (( 1.0 - CZY_VariationAmount ) + (tex2D( _FogVariationTexture, (( (temp_output_97_0_g19).xz + ( (CZY_VariationWindDirection).xz * _TimeParameters.x ) )*( 0.1 / CZY_VariationScale ) + 0.0) ).r - 0.0) * (1.0 - ( 1.0 - CZY_VariationAmount )) / (1.0 - 0.0)) ) , ( 1.0 - saturate( ( preDepth120_g19 / CZY_VariationDistance ) ) ));
				...
				float temp_output_75_0_g19 = ( finalAlpha141_g19 * saturate( ( ( 1.0 - saturate( ( ( ( direction90_g19.y * 0.1 ) * ( 1.0 / ( ( CZY_FogSmoothness * length( ase_objectScale ) ) * 10.0 ) ) ) + ( 1.0 - CZY_FogOffset ) ) ) ) * CZY_FogIntensity ) ) );
				float4 lerpResult22_g1 = lerp( fetchOpaqueVal25_g1 , ( ( temp_output_10_0_g23 * CZY_SunFilterColor ) + temp_output_10_0_g22 ) , temp_output_75_0_g19);
				
				float2 UV22_g3 = ase_screenPosNorm.xy;
				float2 localUnStereo22_g3 = UnStereo( UV22_g3 );
				float2 break64_g2 = localUnStereo22_g3;
				float clampDepth69_g2 = SampleCameraDepth( ase_screenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				...
				float3 In73_g2 = temp_output_46_0_g2;
				float3 localInvertDepthDirHD73_g2 = InvertDepthDirHD73_g2( In73_g2 );
				float4 appendResult49_g2 = (float4(localInvertDepthDirHD73_g2 , 1.0));
				float3 appendResult6_g1 = (float3(mul( unity_CameraToWorld, appendResult49_g2 ).xyz));
				float temp_output_11_0_g1 = length( ( appendResult6_g1 - _WorldSpaceCameraPos ) );
				float switchResult23_g1 = (((ase_vface>0)?(( ( temp_output_11_0_g1 > temp_output_12_0_g1 ? 1.0 : 0.0 ) * temp_output_19_0_g1 )):(( isInsideBoundingBox5_g1 * ( temp_output_11_0_g1 < temp_output_12_0_g1 ? 1.0 : 0.0 ) ))));
				
				surfaceDescription.Color = ( temp_output_19_0_g1 == 1.0 ? lerpResult22_g1 : fetchOpaqueVal25_g1 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = switchResult23_g1;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;29;-168.4662,9.018967;Inherit;False;Fog Culling;0;;1;8ec1ce8cf4b40a142b3c3eda6d2e5a96;0;0;2;COLOR;0;FLOAT;38
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;21;0,0;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;13;Distant Lands/Cozy/HDRP/Fog Culling;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;True;True;2;False;_DoubleSidedEnable;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;True;True;True;0;True;_StencilRef;221;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638429352155889769;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;1;638412784836081710;Alpha Clipping;0;0;Receive Decals;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;True;True;True;True;True;False;True;False;;False;0
