...
Shader "Distant Lands/Cozy/HDRP/Stylized Clouds (Ghibli Mobile)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 hsvTorgb2_g70 = RGBToHSV( CZY_CloudHighlightColor.rgb );
				...
				float4 CloudHighlightColor91_g66 = ( temp_output_10_0_g70 * CZY_CloudFilterColor );
				float3 hsvTorgb2_g69 = RGBToHSV( CZY_CloudColor.rgb );
				...
				float4 CloudColor73_g66 = ( temp_output_10_0_g69 * CZY_CloudFilterColor );
				Gradient gradient68_g66 = NewGradient( 0, 2, 2, float4( 0, 0, 0, 0.8676432 ), float4( 1, 1, 1, 0.9294118 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord11_g66 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_54_0_g66 = ( texCoord11_g66 - float2( 0.5,0.5 ) );
				float dotResult23_g66 = dot( temp_output_54_0_g66 , temp_output_54_0_g66 );
				float Dot28_g66 = saturate( (0.85 + (dotResult23_g66 - 0.0) * (3.0 - 0.85) / (1.0 - 0.0)) );
				float time35_g68 = 0.0;
				float2 voronoiSmoothId35_g68 = 0;
				float2 texCoord21_g66 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 CentralUV17_g66 = ( texCoord21_g66 + float2( -0.5,-0.5 ) );
				float2 temp_output_21_0_g68 = (CentralUV17_g66*1.58 + 0.0);
				...
				float Spherize29_g66 = CZY_Spherize;
				float Flatness30_g66 = ( 20.0 * CZY_Spherize );
				float mulTime14_g66 = _TimeParameters.x * ( 0.001 * CZY_WindSpeed );
				float Time8_g66 = mulTime14_g66;
				float2 Wind51_g66 = ( Time8_g66 * float2( 0.1,0.2 ) );
				float2 temp_output_10_0_g68 = (( ( temp_output_21_0_g68 * ( pow( saferPower6_g68 , Spherize29_g66 ) * Flatness30_g66 ) ) + float2( 0.5,0.5 ) )*( 2.0 / 5.0 ) + Wind51_g66);
				...
				float2 texCoord12_g66 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_15_0_g66 = ( texCoord12_g66 - float2( 0.5,0.5 ) );
				float dotResult7_g66 = dot( temp_output_15_0_g66 , temp_output_15_0_g66 );
				float ModifiedCohesion22_g66 = ( CZY_CloudCohesion * 1.0 * ( 1.0 - dotResult7_g66 ) );
				float lerpResult15_g68 = lerp( saturate( ( voroi35_g68 + voroi13_g68 ) ) , voroi11_g68 , ModifiedCohesion22_g66);
				float CumulusCoverage113_g66 = CZY_CumulusCoverageMultiplier;
				float lerpResult16_g68 = lerp( lerpResult15_g68 , 1.0 , ( ( 1.0 - CumulusCoverage113_g66 ) + -0.7 ));
				float time35_g71 = 0.0;
				float2 voronoiSmoothId35_g71 = 0;
				float2 temp_output_21_0_g71 = CentralUV17_g66;
				...
				float Scale24_g66 = ( CZY_MainCloudScale * 0.1 );
				float2 temp_output_10_0_g71 = (( ( temp_output_21_0_g71 * ( pow( saferPower6_g71 , Spherize29_g66 ) * Flatness30_g66 ) ) + float2( 0.5,0.5 ) )*( 2.0 / ( Scale24_g66 * 1.5 ) ) + ( Wind51_g66 * float2( 0.5,0.5 ) ));
				...
				float lerpResult15_g71 = lerp( saturate( ( voroi35_g71 + voroi13_g71 ) ) , voroi11_g71 , ( ModifiedCohesion22_g66 * 1.1 ));
				float lerpResult16_g71 = lerp( lerpResult15_g71 , 1.0 , ( ( 1.0 - CumulusCoverage113_g66 ) + -0.7 ));
				float temp_output_25_0_g66 = saturate( (0.0 + (( Dot28_g66 * ( 1.0 - lerpResult16_g71 ) ) - 0.6) * (1.0 - 0.0) / (1.0 - 0.6)) );
				float IT2PreAlpha80_g66 = temp_output_25_0_g66;
				float temp_output_77_0_g66 = (0.0 + (( Dot28_g66 * ( 1.0 - lerpResult16_g68 ) ) - 0.6) * (IT2PreAlpha80_g66 - 0.0) / (1.5 - 0.6));
				float clampResult71_g66 = clamp( temp_output_77_0_g66 , 0.0 , 0.9 );
				float AdditionalLayer66_g66 = SampleGradient( gradient68_g66, clampResult71_g66 ).r;
				float4 lerpResult88_g66 = lerp( CloudColor73_g66 , ( CloudColor73_g66 * CZY_CloudTextureColor ) , AdditionalLayer66_g66);
				float4 ModifiedCloudColor97_g66 = lerpResult88_g66;
				Gradient gradient87_g66 = NewGradient( 0, 2, 2, float4( 0.06119964, 0.06119964, 0.06119964, 0.4411841 ), float4( 1, 1, 1, 0.5794156 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float time35_g67 = 0.0;
				float2 voronoiSmoothId35_g67 = 0;
				float2 ShadowUV59_g66 = ( CentralUV17_g66 + ( CentralUV17_g66 * float2( -1,-1 ) * CZY_ShadowingDistance * Dot28_g66 ) );
				float2 temp_output_21_0_g67 = ShadowUV59_g66;
				...
				float2 temp_output_10_0_g67 = (( ( temp_output_21_0_g67 * ( pow( saferPower6_g67 , Spherize29_g66 ) * Flatness30_g66 ) ) + float2( 0.5,0.5 ) )*( 2.0 / ( Scale24_g66 * 1.5 ) ) + ( Wind51_g66 * float2( 0.5,0.5 ) ));
				...
				float lerpResult15_g67 = lerp( saturate( ( voroi35_g67 + voroi13_g67 ) ) , voroi11_g67 , ( ModifiedCohesion22_g66 * 1.1 ));
				float lerpResult16_g67 = lerp( lerpResult15_g67 , 1.0 , ( ( 1.0 - CumulusCoverage113_g66 ) + -0.7 ));
				float4 lerpResult104_g66 = lerp( CloudHighlightColor91_g66 , ModifiedCloudColor97_g66 , saturate( SampleGradient( gradient87_g66, saturate( (0.0 + (( Dot28_g66 * ( 1.0 - lerpResult16_g67 ) ) - 0.6) * (1.0 - 0.0) / (1.0 - 0.6)) ) ).r ));
				float4 IT2Color100_g66 = lerpResult104_g66;
				
				Gradient gradient93_g66 = NewGradient( 0, 2, 2, float4( 0.06119964, 0.06119964, 0.06119964, 0.4617685 ), float4( 1, 1, 1, 0.5117723 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float IT2Alpha101_g66 = SampleGradient( gradient93_g66, temp_output_25_0_g66 ).r;
				
				surfaceDescription.Color = IT2Color100_g66.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( IT2Alpha101_g66 * ( 1.0 - 0.0 ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				Gradient gradient93_g66 = NewGradient( 0, 2, 2, float4( 0.06119964, 0.06119964, 0.06119964, 0.4617685 ), float4( 1, 1, 1, 0.5117723 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord11_g66 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_54_0_g66 = ( texCoord11_g66 - float2( 0.5,0.5 ) );
				float dotResult23_g66 = dot( temp_output_54_0_g66 , temp_output_54_0_g66 );
				float Dot28_g66 = saturate( (0.85 + (dotResult23_g66 - 0.0) * (3.0 - 0.85) / (1.0 - 0.0)) );
				float time35_g71 = 0.0;
				float2 voronoiSmoothId35_g71 = 0;
				float2 texCoord21_g66 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 CentralUV17_g66 = ( texCoord21_g66 + float2( -0.5,-0.5 ) );
				float2 temp_output_21_0_g71 = CentralUV17_g66;
				float2 break2_g71 = abs( temp_output_21_0_g71 );
				float saferPower4_g71 = abs( break2_g71.x );
				...
				voroi11_g71 /= rest11_g71;
				float2 texCoord12_g66 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_15_0_g66 = ( texCoord12_g66 - float2( 0.5,0.5 ) );
				float dotResult7_g66 = dot( temp_output_15_0_g66 , temp_output_15_0_g66 );
				float ModifiedCohesion22_g66 = ( CZY_CloudCohesion * 1.0 * ( 1.0 - dotResult7_g66 ) );
				float lerpResult15_g71 = lerp( saturate( ( voroi35_g71 + voroi13_g71 ) ) , voroi11_g71 , ( ModifiedCohesion22_g66 * 1.1 ));
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 CloudColor73_g66 = ( temp_output_10_0_g69 * CZY_CloudFilterColor );
				Gradient gradient68_g66 = NewGradient( 0, 2, 2, float4( 0, 0, 0, 0.8676432 ), float4( 1, 1, 1, 0.9294118 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord11_g66 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_54_0_g66 = ( texCoord11_g66 - float2( 0.5,0.5 ) );
				float dotResult23_g66 = dot( temp_output_54_0_g66 , temp_output_54_0_g66 );
				float Dot28_g66 = saturate( (0.85 + (dotResult23_g66 - 0.0) * (3.0 - 0.85) / (1.0 - 0.0)) );
				float time35_g68 = 0.0;
				float2 voronoiSmoothId35_g68 = 0;
				float2 texCoord21_g66 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 CentralUV17_g66 = ( texCoord21_g66 + float2( -0.5,-0.5 ) );
				float2 temp_output_21_0_g68 = (CentralUV17_g66*1.58 + 0.0);
				float2 break2_g68 = abs( temp_output_21_0_g68 );
				float saferPower4_g68 = abs( break2_g68.x );
				...
				voroi11_g68 /= rest11_g68;
				float2 texCoord12_g66 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_15_0_g66 = ( texCoord12_g66 - float2( 0.5,0.5 ) );
				float dotResult7_g66 = dot( temp_output_15_0_g66 , temp_output_15_0_g66 );
				float ModifiedCohesion22_g66 = ( CZY_CloudCohesion * 1.0 * ( 1.0 - dotResult7_g66 ) );
				float lerpResult15_g68 = lerp( saturate( ( voroi35_g68 + voroi13_g68 ) ) , voroi11_g68 , ModifiedCohesion22_g66);
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				Gradient gradient93_g66 = NewGradient( 0, 2, 2, float4( 0.06119964, 0.06119964, 0.06119964, 0.4617685 ), float4( 1, 1, 1, 0.5117723 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float2 texCoord11_g66 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_54_0_g66 = ( texCoord11_g66 - float2( 0.5,0.5 ) );
				float dotResult23_g66 = dot( temp_output_54_0_g66 , temp_output_54_0_g66 );
				float Dot28_g66 = saturate( (0.85 + (dotResult23_g66 - 0.0) * (3.0 - 0.85) / (1.0 - 0.0)) );
				float time35_g71 = 0.0;
				float2 voronoiSmoothId35_g71 = 0;
				float2 texCoord21_g66 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 CentralUV17_g66 = ( texCoord21_g66 + float2( -0.5,-0.5 ) );
				float2 temp_output_21_0_g71 = CentralUV17_g66;
				float2 break2_g71 = abs( temp_output_21_0_g71 );
				float saferPower4_g71 = abs( break2_g71.x );
				...
				voroi11_g71 /= rest11_g71;
				float2 texCoord12_g66 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_15_0_g66 = ( texCoord12_g66 - float2( 0.5,0.5 ) );
				float dotResult7_g66 = dot( temp_output_15_0_g66 , temp_output_15_0_g66 );
				float ModifiedCohesion22_g66 = ( CZY_CloudCohesion * 1.0 * ( 1.0 - dotResult7_g66 ) );
				float lerpResult15_g71 = lerp( saturate( ( voroi35_g71 + voroi13_g71 ) ) , voroi11_g71 , ( ModifiedCohesion22_g66 * 1.1 ));
